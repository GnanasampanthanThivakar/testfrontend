          ...
          <div className="relative h-40">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                ...
                />
                <div
                  className="absolute inset-0 w-32 h-32 -m-4 border border-white/20 rounded-full animate-spin"
...
function App() {
  ...
  return (
    <UserContextProvider>
      <div
        className="App"
        style={{ backgroundColor: "#290000", color: "#FFFFFF" }}
      >
        {loading ? (
          <LuxuryLoadingScreen />
        ) : (
          <BrowserRouter>
            <Helmet>
              ...
              <meta
                property="og:title"
                content="SJ Photography - Capture Your Precious Moments"
              />
              <meta
                property="og:description"
                content="Professional wedding and event photography services that make your dreams come true."
              />
              <meta
                property="og:image"
                content="https://sjphotography.com/og-image.jpg"
              />
